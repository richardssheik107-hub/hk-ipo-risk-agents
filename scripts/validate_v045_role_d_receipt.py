"""Validate the committed Role-D recorded materialization receipt."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--receipt",
        type=Path,
        default=Path("reports/frozen/v045_role_d_m5_materialization_receipt.json"),
    )
    parser.add_argument(
    ...
    report = validate_role_d_materialization_receipt(
        args.receipt,
