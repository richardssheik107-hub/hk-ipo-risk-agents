...
def main() -> int:
    ...
    result = materialize_oracle_v2(root=args.root, production_dir=args.production_dir, target_dir=args.target_dir, output_dir=args.output_dir, resume=args.resume)
