...
def apply_competition_theme() -> None:
    ...
    st.markdown(
        ...
        <style>
        :root {
          --ipo-bg:#f4f6f8; --ipo-surface:#ffffff; --ipo-surface-alt:#f8fafc;
        ...
        html,body,[class*="css"] {font-family:Inter,"Noto Sans SC","Microsoft YaHei",sans-serif;color:var(--ipo-ink);}
        [data-testid="stAppViewContainer"] {background:var(--ipo-bg);}
        ...
        .hero-v3-copy {position:relative;z-index:2;max-width:680px;}
        .hero-v3-label {font-size:.68rem;font-weight:760;letter-spacing:.075em;color:#8fd0d0;margin-bottom:1rem;opacity:0;animation:product-enter var(--motion-enter) var(--ease-product) 80ms forwards;}
        .hero-v3-title {font-size:clamp(2.35rem,4.4vw,3.65rem);line-height:1.06;letter-spacing:-.047em;font-weight:770;color:#fff!important;margin:0;opacity:0;animation:product-enter var(--motion-enter) var(--ease-product) 150ms forwards;}
        .hero-v3-subtitle {font-size:1.05rem;line-height:1.65;color:#d4e1e8;max-width:620px;margin:1rem 0 .48rem;opacity:0;animation:product-enter var(--motion-enter) var(--ease-product) 260ms forwards;}
        .hero-v3-detail {font-size:.78rem;line-height:1.55;color:#9fb6c5;max-width:620px;opacity:0;animation:product-enter var(--motion-enter) var(--ease-product) 340ms forwards;}
        .hero-v3-actions {display:flex;align-items:center;gap:1rem;margin-top:1.35rem;opacity:0;animation:product-enter var(--motion-enter) var(--ease-product) 1.02s forwards;}
        ...
        .risk-flow-visual {position:relative;min-width:0;opacity:0;filter:saturate(.98);animation:product-enter var(--motion-enter) var(--ease-product) 320ms forwards;}
        .risk-flow-visual:before {content:"";position:absolute;inset:8% 0 1% 4%;border-radius:50%;background:radial-gradient(circle,rgba(28,190,184,.12),rgba(65,170,174,.045) 42%,transparent 65%);filter:blur(12px);opacity:.72;transform:translate3d(0,0,0) scale(.97);will-change:transform,opacity;animation:hero-visual-halo 18s cubic-bezier(.42,0,.28,1) infinite alternate;pointer-events:none;}
        .risk-flow-visual svg {position:relative;display:block;width:112%;max-width:none;height:auto;max-height:386px;margin-left:-5%;overflow:visible;}
        .hero-canvas-bg {opacity:0;animation:hero-layer-in 620ms var(--ease-product) 330ms forwards;}
        .hero-doc-stack {opacity:0;transform-box:fill-box;transform-origin:center;transform:translateY(14px) scale(.985);animation:hero-layer-in 520ms var(--ease-product) 390ms forwards;}
        .hero-evidence {opacity:0;transform-box:fill-box;transform-origin:center;transform:translate(-8px,8px);animation:hero-layer-in 460ms var(--ease-product) 570ms forwards;}
        .hero-evidence-sweep {transform-box:fill-box;transform-origin:left center;transform:scaleX(0);animation:flow-highlight 420ms var(--ease-product) 690ms forwards;}
        .hero-connector {stroke-dasharray:260;stroke-dashoffset:260;animation:flow-draw 620ms var(--ease-product) 650ms forwards;}
        .hero-float-module {opacity:0;transform-box:fill-box;transform-origin:center;transform:translateY(10px) scale(.975);animation:hero-layer-in 460ms var(--ease-product) forwards;}
        .hero-risk-summary {animation-delay:720ms}.hero-market-signal{animation-delay:790ms}.hero-rule-signal{animation-delay:880ms}.hero-final-review{animation-delay:970ms}
        .hero-market-line {stroke-dasharray:170;stroke-dashoffset:170;animation:flow-draw 620ms var(--ease-product) 980ms forwards;}
        .hero-audit-mark {opacity:0;transform-box:fill-box;transform-origin:center;transform:scale(.7);animation:hero-audit-in 380ms var(--ease-product) 1160ms forwards;}
        @keyframes hero-mask {from{opacity:0;clip-path:inset(0 0 100% 0 round 18px)}to{opacity:1;clip-path:inset(0 0 0 0 round 18px)}}
        @keyframes hero-mesh-drift-a {0%{opacity:.54;transform:translate3d(-18px,-10px,0) scale(.96)}55%{opacity:.66;transform:translate3d(24px,18px,0) scale(1.035)}100%{opacity:.58;transform:translate3d(42px,-4px,0) scale(1.01)}}
        @keyframes hero-mesh-drift-b {0%{opacity:.58;transform:translate3d(12px,8px,0) scale(.98)}50%{opacity:.72;transform:translate3d(-24px,-12px,0) scale(1.035)}100%{opacity:.62;transform:translate3d(-38px,16px,0) scale(1.01)}}
        @keyframes hero-visual-halo {0%{opacity:.58;transform:translate3d(-8px,5px,0) scale(.97)}55%{opacity:.76;transform:translate3d(10px,-7px,0) scale(1.035)}100%{opacity:.66;transform:translate3d(18px,4px,0) scale(1.01)}}
        @keyframes hero-layer-in {to{opacity:1;transform:translate(0,0) scale(1)}}
        @keyframes hero-audit-in {to{opacity:1;transform:scale(1)}}
        @keyframes flow-highlight {to{transform:scaleX(1)}}
...
def render_product_header(payload: dict[str, Any] | None = None, *, runtime_label: str = "待运行") -> None:
    ...
    if payload is None:
        st.markdown(
            ...
            "<filter id='heroShadow' x='-30%' y='-30%' width='160%' height='180%'><feDropShadow dx='0' dy='12' stdDeviation='12' flood-color='#061d2e' flood-opacity='.3'/></filter>"
            "<filter id='heroSoftShadow' x='-30%' y='-30%' width='160%' height='180%'><feDropShadow dx='0' dy='7' stdDeviation='7' flood-color='#061d2e' flood-opacity='.22'/></filter>"
            ...
            "<g fill='none' stroke='#83cfcb' stroke-width='1.5' stroke-linecap='round' opacity='.48'><path class='hero-connector' d='M276 167C218 168 190 224 166 278'/><path class='hero-connector' d='M407 125C431 111 446 98 466 90'/><path class='hero-connector' d='M405 244C466 246 495 264 504 288'/></g>"
            "<g class='hero-doc-stack' filter='url(#heroShadow)'>"
            ...
            "</g>"
            "<g class='hero-evidence' filter='url(#heroSoftShadow)'><rect x='88' y='135' width='206' height='76' rx='14' fill='#f8fbfb' stroke='#b9d7d8'/><rect x='88' y='135' width='5' height='76' rx='2.5' fill='#d8b15a'/><text x='108' y='157' fill='#8b6a27' font-size='7.5' font-weight='800' letter-spacing='.8'>EVIDENCE · SOURCE LINKED</text><rect class='hero-evidence-sweep' x='108' y='169' width='158' height='11' rx='4' fill='url(#heroEvidenceFill)'/><rect x='108' y='187' width='128' height='4' rx='2' fill='#cad8dd'/><circle cx='272' cy='174' r='7' fill='#fff7e6' stroke='#d2a64c'/><path d='M269 174l2 2 4-5' fill='none' stroke='#a8791d' stroke-width='1.4'/></g>"
            "<g class='hero-float-module hero-market-signal' filter='url(#heroSoftShadow)'><rect x='404' y='56' width='184' height='108' rx='17' fill='url(#heroGlass)' stroke='#4c7c89'/><text x='426' y='80' fill='#b9d8da' font-size='8' font-weight='800' letter-spacing='.8'>MARKET SIGNAL</text><text x='426' y='94' fill='#739aa5' font-size='6.5' font-weight='650'>CONTEXT LAYER</text><g clip-path='url(#marketClip)'><path d='M430 140L447 132L463 136L480 116L497 124L515 105L535 113L556 90V148H430Z' fill='#3ba9ab' opacity='.14'/><path class='hero-market-line' d='M430 140L447 132L463 136L480 116L497 124L515 105L535 113L556 90' fill='none' stroke='#75d0cb' stroke-width='2'/></g><line x1='430' y1='148' x2='562' y2='148' stroke='#557987' stroke-opacity='.55'/><circle cx='568' cy='76' r='4' fill='#d8b15a'/></g>"
            "<g class='hero-float-module hero-risk-summary' filter='url(#heroSoftShadow)'><rect x='38' y='268' width='204' height='116' rx='18' fill='#f7fafb' stroke='#b7d0d5'/><text x='60' y='292' fill='#25495b' font-size='8' font-weight='800' letter-spacing='.8'>RISK REVIEW</text><circle cx='211' cy='288' r='8' fill='#e7f2f1'/><path d='M207 288l3 3 6-7' fill='none' stroke='#238d89' stroke-width='1.5'/><text x='60' y='319' fill='#607783' font-size='7'>FINANCIAL</text><rect x='119' y='313' width='90' height='7' rx='3.5' fill='#d8e4e7'/><rect x='119' y='313' width='54' height='7' rx='3.5' fill='#73bbb8'/><text x='60' y='342' fill='#607783' font-size='7'>LEGAL</text><rect x='119' y='336' width='90' height='7' rx='3.5' fill='#d8e4e7'/><rect x='119' y='336' width='66' height='7' rx='3.5' fill='#d8b15a'/><text x='60' y='365' fill='#607783' font-size='7'>BUSINESS</text><rect x='119' y='359' width='90' height='7' rx='3.5' fill='#d8e4e7'/><rect x='119' y='359' width='44' height='7' rx='3.5' fill='#5c9fa3'/></g>"
            "<g class='hero-float-module hero-rule-signal' filter='url(#heroSoftShadow)'><rect x='430' y='178' width='145' height='58' rx='15' fill='#173f52' stroke='#527f8b'/><path d='M448 194l8-4 8 4v7c0 6-4 10-8 12-4-2-8-6-8-12z' fill='#74c5c1' opacity='.9'/><path d='M452 201l3 3 5-7' fill='none' stroke='#103c4e' stroke-width='1.5'/><text x='474' y='199' fill='#c5dfdf' font-size='7.5' font-weight='800'>RULE / GOVERNANCE</text><text x='474' y='214' fill='#789ca6' font-size='6.5'>Policy checks retained</text></g>"
            "<g class='hero-float-module hero-final-review' filter='url(#heroShadow)'><rect x='368' y='248' width='238' height='142' rx='21' fill='url(#heroFinal)' stroke='#8bc9c5' stroke-width='1.2'/><circle cx='398' cy='280' r='15' fill='#d8f1ee'/><g class='hero-audit-mark'><path d='M391 280l5 5 10-12' fill='none' stroke='#176b75' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'/></g><text x='423' y='275' fill='#ffffff' font-size='10.5' font-weight='800' letter-spacing='.5'>FINAL REVIEW</text><text x='423' y='290' fill='#9ed0cf' font-size='7'>GOVERNED SUMMARY</text><line x1='390' y1='307' x2='581' y2='307' stroke='#92c3c3' stroke-opacity='.32'/><circle cx='397' cy='326' r='3.5' fill='#84d0cb'/><text x='409' y='329' fill='#d4e9e8' font-size='7.5'>Evidence linked</text><rect x='510' y='321' width='66' height='12' rx='6' fill='#2e7d83'/><text x='522' y='329.5' fill='#c7e6e4' font-size='6'>TRACEABLE</text><circle cx='397' cy='350' r='3.5' fill='#d8b15a'/><text x='409' y='353' fill='#d4e9e8' font-size='7.5'>Limits retained</text><rect x='510' y='345' width='66' height='12' rx='6' fill='#2e7d83'/><text x='524' y='353.5' fill='#c7e6e4' font-size='6'>REVIEWED</text><path d='M577 370h-76' stroke='#86b8b9' stroke-width='1.2'/><circle cx='584' cy='370' r='4' fill='#d8b15a'/></g>"
            "</svg></div></section>",
            unsafe_allow_html=True,
        )
        return
