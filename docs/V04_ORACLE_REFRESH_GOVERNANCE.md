...
> Status: **FROZEN GOVERNANCE / ORACLE v2 COMPLETE / FROZEN**
> Date: 2026-08-23
...
| Oracle v2 | materialized / reproducible / **complete / frozen** | 98 | 96 | 77 | 19 |
...
under a separate versioned contract, bound to the frozen 438-case PR-A
Production and PR-C Outcome inputs, and passed Role A final sign-off. PR-E
formal training remains not started.
...
The frozen contract is `expert_oracle_document_features_v2` /
