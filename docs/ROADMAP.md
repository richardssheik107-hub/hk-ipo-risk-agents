...
| v0.4.0 | 市场数据、收益标签与预测模型 | V04-1 MERGED；V04-2 IMPLEMENTED PENDING REVIEW；模型未开始 |
...
- v0.4 的 Market Foundation 已合并；V04-2文档风险快照/特征/数据集契约已实现并等待
  Review。普通股-only证券资格及2025 blind outcome均fail closed，模型尚未开始。
