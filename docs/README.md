...
| [`END_TO_END_CLOSED_LOOP_MASTER_PLAN.md`](END_TO_END_CLOSED_LOOP_MASTER_PLAN.md) | v0.4 baseline E2E 总计划 |
...
- [`research/RETRIEVER_V3_PREFLIGHT_AND_RERANKER_V11_DECISIONS.md`](research/RETRIEVER_V3_PREFLIGHT_AND_RERANKER_V11_DECISIONS.md) — v0.5 restart constraints only
...
完整本轮清理记录见 [`DOCUMENTATION_AUDIT_2026-08-23.md`](DOCUMENTATION_AUDIT_2026-08-23.md)。
